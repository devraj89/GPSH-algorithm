...
N = 2173;
kernelSamps = [50, 50];                            % sampling size for kernel logistic regression
...
for di = 1 : dtN
    ...
    for bi = 1 : bitN        
        ...
        for ri = 1 : runtimes
            ...
            % matrix update hash codes
            [A,B,f] = generate_hash_codes8_matrix_update(P,size(P,1),size(P,2),bit,A0,B0,1);
